...
ENGINE_SRC=(
  ...
  "$ROOT/src/storage/identity_store.cpp" "$ROOT/src/storage/secure_blob.cpp" "$ROOT/src/vault.cpp" "$ROOT/src/attachment.cpp" "$ROOT/src/safety_number.cpp" "$ROOT/src/release_signature.cpp" "$ROOT/src/backup.cpp"
